 => let val  (INTCONST as INTCONST1) = INTCONST1 ()
 in (INTCONST)
end)
 in ( LrTable.NT 11, ( result, INTCONST1left, INTCONST1right), rest671
)
end
|  ( 32, ( ( _, ( _, (PLUSleft as PLUS1left), (PLUSright as PLUS1right
))) :: rest671)) => let val  result = MlyValue.addop (fn _ => (
(PLUS , PLUSleft , PLUSright)))
 in ( LrTable.NT 12, ( result, PLUS1left, PLUS1right), rest671)
end
|  ( 33, ( ( _, ( _, (MINUSleft as MINUS1left), (MINUSright as 
...
|  ( 34, ( ( _, ( _, (TIMESleft as TIMES1left), (TIMESright as 
...
|  ( 35, ( ( _, ( _, (DIVleft as DIV1left), (DIVright as DIV1right)))
 :: rest671)) => let val  result = MlyValue.mulop (fn _ => (
(DIV  , DIVleft  , DIVright)))
 in ( LrTable.NT 13, ( result, DIV1left, DIV1right), rest671)
end
|  ( 36, ( ( _, ( _, (MODleft as MOD1left), (MODright as MOD1right)))
 :: rest671)) => let val  result = MlyValue.mulop (fn _ => (
(MOD  , MODleft  , MODright)))
 in ( LrTable.NT 13, ( result, MOD1left, MOD1right), rest671)
end
|  ( 37, ( ( _, ( _, (LTleft as LT1left), (LTright as LT1right))) :: 
rest671)) => let val  result = MlyValue.relop (fn _ => (
(LT , LTleft , LTright)))
 in ( LrTable.NT 14, ( result, LT1left, LT1right), rest671)
end
|  ( 38, ( ( _, ( _, (LEQleft as LEQ1left), (LEQright as LEQ1right)))
 :: rest671)) => let val  result = MlyValue.relop (fn _ => (
(LEQ, LEQleft, LEQright)))
 in ( LrTable.NT 14, ( result, LEQ1left, LEQ1right), rest671)
end
|  ( 39, ( ( _, ( _, (EQleft as EQ1left), (EQright as EQ1right))) :: 
rest671)) => let val  result = MlyValue.relop (fn _ => (
(EQ , EQleft , EQright)))
 in ( LrTable.NT 14, ( result, EQ1left, EQ1right), rest671)
end
|  ( 40, ( ( _, ( _, (GTleft as GT1left), (GTright as GT1right))) :: 
rest671)) => let val  result = MlyValue.relop (fn _ => (
(GT , GTleft , GTright)))
 in ( LrTable.NT 14, ( result, GT1left, GT1right), rest671)
end
|  ( 41, ( ( _, ( _, (GEQleft as GEQ1left), (GEQright as GEQ1right)))
 :: rest671)) => let val  result = MlyValue.relop (fn _ => (
(GEQ, GEQleft, GEQright)))
 in ( LrTable.NT 14, ( result, GEQ1left, GEQ1right), rest671)
end
|  ( 42, ( ( _, ( _, (NEQleft as NEQ1left), (NEQright as NEQ1right)))
 :: rest671)) => let val  result = MlyValue.relop (fn _ => (
